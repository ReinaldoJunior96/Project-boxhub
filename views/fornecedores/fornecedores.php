            ...
            <div class="">
                ...
                <div class="mt-2">
                    ...
                    <div class="container roboto-condensed">
                        <form method="POST" action="../../back/response/fornecedores/fornecedores_n.php">
                        ...
                        <table id="example" class="table table-sm text-center roboto-condensed">
                            ...
                            foreach ($fornecedores as $v) {
                                ...
                                <tr>
                                    ...
                                    <?php echo "<td><a href=../../back/response/fornecedores/d_fornecedor.php?idfornecedor=" . $v->id_fornecedor . "><i class='fas fa-trash-alt fa-1x text-danger'></i></a></td>" ?>
                                </tr>
                            <?php } ?>
                            </tbody>
                        </table>
