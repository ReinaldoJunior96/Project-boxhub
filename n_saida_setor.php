...
<nav class="navbar navbar-expand-lg navbar-light bg-nav">
    ...
    <div class="container">
        <h3 class='exo titulo-1 mt-5'>Setor de saída: <?= $_GET['nomesetor'] ?><a href='vd_historico_saida.php' class='link-basico float-right'>Histórico de saída <i class='fas fa-history '></i></a></h3>
        <hr class='bg-nav'>
    </div>
    <div class="container text-center justify-content-center col-sm-8">
                ...
                foreach ($all_estoque as $v) {
                    ...
                    <tr class="text-center">
                        <form method="POST" action="back/response/n_saida_r.php">
                            ...
                            <td><?= $v->produto_e ?></td>
                            <td><input type="text" class="form-control" name="saidaqte_p" id="inputPassword4" placeholder="" style="text-align: center;"></td>
                            <td><button type="submit" class="btn bg-color-btn comfortaa mt-1">Saída <i class="fas fa-sign-out-alt"></i></td>
                        </form>
                    </tr>
                <?php } ?>
            </tbody>
